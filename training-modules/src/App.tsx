...
//         return (
//           <div className="p-8">
//             <h1 className="text-3xl font-bold mb-4">PaceSim Training Platform</h1>
//             <p className="text-gray-600 mb-6">External Pacemaker Simulation Platform</p>
            
//             <div className="space-y-4">
//               <div className="p-4 bg-blue-50 rounded-lg">
//                 <h3 className="font-semibold">Module 1: Scenario 1</h3>
//                 <p className="text-sm text-gray-600">Diagnose and correct a failure to sense condition</p>
//                 <button 
...
//               ← Back to Home
//             </button>
//             <h1 className="text-2xl font-bold mb-4">Module 1: Scenario 1</h1>
//             <div className="bg-green-50 p-4 rounded-lg">
//               <p>🎯 Module page is working! We'll add the ECG and quiz components here.</p>
//             </div>
//             <ECGVisualizer
//               rate={180}
//               aOutput={5}
...
// src/App.tsx - Fixed version with working ECG
import { useState } from 'react'
import ECGVisualizer from './components/ECGVisualizer'
