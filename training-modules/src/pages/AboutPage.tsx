...
const AboutPage = () => {
  ...
  const teamMembers = [
    ...
    {
      name: "Dauryne Shaffer & Pamela Moss",
      role: "Clinical Partners (JHH)",
      description:
  ...
  const techStack = [
    ...
    {
      name: "WebSocket",
      description: "Real-time communication with pacemaker",
    },
    { name: "SQLite", description: "Local data storage & offline support" },
    {
      name: "Raspberry Pi + Arduino",
      description: "Hardware prototyping & integration",
    },
  ];
    ...
    <div className="pb-16">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">
          This project was created as part of the Multidisciplinary Engineering
          Design course at Johns Hopkins University during the 2024–2025
          academic year in partnership with Johns Hopkins Hospital.
        </p>
      </div>
      ...
      <div className="w-full px-8 py-6 bg-white shadow-lg rounded-3xl mb-6">
        ...
        <p className="text-gray-700 leading-relaxed">
          PaceSim empowers nursing professionals to develop real-world
          proficiency in external pacemaker usage through scenario-based
          simulation, interactive feedback, and hands-on device integration. We
